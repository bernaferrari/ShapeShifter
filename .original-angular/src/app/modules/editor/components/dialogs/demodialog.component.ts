...
@Component({
  ...
  template: ` <span matDialogTitle>Choose a demo</span>
    ...
    <mat-dialog-actions fxLayout="row">
      ...
      <span fxFlex></span>
      <button fxFlexOrder="2" mat-button (click)="this.dialogRef.close(this.selectedDemoInfo)">
        OK
      </button>
