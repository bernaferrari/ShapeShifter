...
@Component({
  ...
  template: ` <span matDialogTitle>Start from scratch?</span>
    <mat-dialog-content>
    ...
    <mat-dialog-actions fxLayout="row">
      ...
      <span fxFlex></span>
      <button fxFlexOrder="3" mat-button (click)="dialogRef.close(this.ADD_TO_WORKSPACE)">
        Add layers
      </button>
      <button fxFlexOrder="2" mat-button (click)="dialogRef.close(this.RESET_WORKSPACE)">
        Start from scratch
      </button>
