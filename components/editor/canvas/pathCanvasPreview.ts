...
export function getPreviewLayers(
  ...
  return layers
    ...
    .map((layer) => ({
      ...
      fillColor: colorAtTime(layer, blocks, "fillColor", currentMs, duration, layer.fillColor ?? ""),
      fillAlpha: numberAtTime(layer, blocks, "fillAlpha", currentMs, duration, layer.fillAlpha ?? 1),
